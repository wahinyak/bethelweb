...
const About = () => {
    const groupData = [
        ...
        { title: "P.C.M.F", description: "Men's fellowship and community service.This group of men seeks to nurture and represent God's divine plan and creation", imgSrc: "https://res.cloudinary.com/dwzwxx7bc/image/upload/w_400,h_250/pcmf_ctngri.jpg" },
        { title: "Youth", description: "Youth activities and support.", imgSrc: "https://images.pexels.com/photos/1250346/pexels-photo-1250346.jpeg?auto=compress&cs=tinysrgb&w=600" },
        ...
        { title: "Church School", description: "Let all little children come to me.", imgSrc: "https://res.cloudinary.com/dwzwxx7bc/image/upload/w_400,h_350/church_school_qbfynu.jpg" },
        { title: "Media Ministry", description: "Media coverage of the Lord's work.", imgSrc: "https://res.cloudinary.com/dwzwxx7bc/image/upload/v1735030387/media_ghrkf7.jpg" },
  ...
  <p className="text-center mb-8 text-gray-900 dark:text-white">Our leadership consists of strong and dedicated men and women that were elected and  have led Bethel faithfully.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="card bg-base-100 w-full sm:w-80 md:w-64 lg:w-95 shadow-xl">
          <figure>
            <img
              src="https://res.cloudinary.com/dwzwxx7bc/image/upload/v1735030377/Muhoro_uvdsjr.jpg"
        ...
        <div className="card bg-base-100 w-full sm:w-80 md:w-64 lg:w-95 shadow-xl">
          <figure>
            <img
              src="https://res.cloudinary.com/dwzwxx7bc/image/upload/v1735030378/Lucy_rnfkvv.jpg"
        ...
        <div className="card bg-base-100 w-full sm:w-80 md:w-64 lg:w-95 shadow-xl">
          <figure>
            <img
              src="https://res.cloudinary.com/dwzwxx7bc/image/upload/v1735030379/Patrick_exzbou.jpg"
        ...
        <div className="card bg-base-100 w-full sm:w-80 md:w-64 lg:w-95 shadow-xl">
          <figure>
            <img
              src="https://res.cloudinary.com/dwzwxx7bc/image/upload/v1735030377/Daniel_bg0cdf.jpg"
        ...
        <div className="card bg-base-100 w-full sm:w-80 md:w-64 lg:w-95 shadow-xl">
          <figure>
            <img
              src="https://res.cloudinary.com/dwzwxx7bc/image/upload/v1735030377/Kiongo_ytneby.jpg"
        ...
        <div className="card bg-base-100 w-full sm:w-80 md:w-64 lg:w-95 shadow-xl">
          <figure>
            <img
              src="https://res.cloudinary.com/dwzwxx7bc/image/upload/v1735030377/Veronica_ywwtug.jpg"
